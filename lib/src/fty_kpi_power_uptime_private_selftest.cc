/*  =========================================================================
    fty_kpi_power_uptime_private_selftest.c - run private classes selftests
...
// Tests for stable private classes:
    if (streq (subtest, "$ALL") || streq (subtest, "dc_test"))
        dc_test (verbose);
    if (streq (subtest, "$ALL") || streq (subtest, "upt_test"))
        upt_test (verbose);
    if (streq (subtest, "$ALL") || streq (subtest, "server_test"))
        fty_kpi_power_uptime_server_test (verbose);
}
/*
################################################################################
#  THIS FILE IS 100% GENERATED BY ZPROJECT; DO NOT EDIT EXCEPT EXPERIMENTALLY  #
